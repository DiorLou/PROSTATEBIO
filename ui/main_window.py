...
class RobotControlWindow(QMainWindow):
    ...
    def create_set_tcp_group(self, layout):
        ...
        self.set_tcp_o_btn = QPushButton("Switch TCP_O")
        self.set_tcp_p_btn = QPushButton("Switch TCP_P")
        self.set_tcp_u_btn = QPushButton("Switch TCP_U")
        self.set_tcp_e_btn = QPushButton("Switch TCP_E")
        self.set_tcp_tip_btn = QPushButton("Switch TCP_tip")
