...
class RobotControlWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.set_tcp_t_btn = None  # <--- 新增: TCP_T 按钮成员变量
    ...
    def setup_connections(self):
        ...
        self.set_tcp_t_btn.clicked.connect(self.set_tcp_t) # <--- 新增连接
    ...
    def create_set_tcp_group(self, layout):
        ...
        self.set_tcp_t_btn = QPushButton("切换TCP_T") # <--- 新增按钮
        ...
        button_layout.addWidget(self.set_tcp_t_btn) # <--- 插入新按钮
    ...
    def set_tcp_t(self):
        """发送设置TCP_T的命令。"""
        self.log_message("SetTCPByName,0,TCP_T;")
        self.tcp_manager.send_command("SetTCPByName,0,TCP_T;")
        self.status_bar.showMessage("状态: 已发送设置TCP_T的命令。")
